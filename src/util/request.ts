...
// 请求拦截
axiosInterface.interceptors.request.use((config: InternalAxiosRequestConfig) => { // 用 AxiosRequestConfig 类型会提示类型错误,似乎新axios版本改动了拦截器参数类型,改用 InternalAxiosRequestConfig
